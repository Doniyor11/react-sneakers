...
function Card({id, title, imgUrl, price, onFavorite, onPlus, favorited = false, added = false, loading = false}) {
                    ...
                    <>
                        ...
                        <div className="d-flex justify-between align-center">
                            ...
                            <img className={styles.plus}
                                 src={isAdded ? "/images/btnchecked.svg" : "/images/btnunchecked.svg"}
